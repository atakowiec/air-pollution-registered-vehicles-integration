        ...
        <Container className={"mt-5 col-12 col-xxl-8 mx-auto mb-5"}>
          ...
          <Row className={"mt-5"}>
            ...
            <div className={"col-12 col-xl-6"}>
              <h3 className={style.chartTitle}>Przykładowy wykres liniowy</h3>
            ...
            <div className={"col-12 col-xl-6"}>
              <h3 className={style.chartTitle}>Przykładowy wykres kołowy</h3>
              <ResponsiveContainer width={"100%"} height={300}>
            ...
            <div className={"col-12 col-xl-6"}>
              <h3 className={style.chartTitle}>Przykładowy wykres radarowy</h3>
              <ResponsiveContainer width={"100%"} height={300}>
